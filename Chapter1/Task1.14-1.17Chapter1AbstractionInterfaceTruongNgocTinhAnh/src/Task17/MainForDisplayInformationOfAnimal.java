...
public class MainForDisplayInformationOfAnimal {
	...
	public static void main(String[] args) {
        ...
        try {
			...
			while (check.equals("y")) {
              ...
              //Enter separate information of each animal
                System.out.println("-----------------------------------------");
				switch (rep) {
				case 1: {
