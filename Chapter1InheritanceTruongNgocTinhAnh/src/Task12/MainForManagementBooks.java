...
public class MainForManagementBooks {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            int count = 0;
            //Calculate fee of text book and display information of text book
            for (TextBook bo : arrayTeBo) {
                bo.DisplayInfoBook();
                totalPrice1 += bo.calculateFee();
                
            }
            //Calculate fee of Reference book and display information of Reference book
            ...
            //Display total price of text book and reference book and average price of reference
            System.out.println("------------------------------------------");
